    ...
    <div class="container-fluid d-flex mt-5" style="justify-content:center">
        <form method="POST" action="{{ route('chisiamo.update', $member->id) }}" class="py-3 mt-5 mb-5" style="width:40%;margin-left:14%">
            ...
            <div class="row mb-3" >
                ...
                <div class="col-mb-3">
                <input type="name" class="form-control" name="name" id="name" placeholder="Nome" value="{{ $member->name }}" required>
                </div>
                <label for="surname" class="col-sm-2 col-form-label">Cognome</label>
                <div class="col-mb-3">
                <input type="surname" class="form-control" name="surname" id="surname" placeholder="Cognome" value="{{ $member->surname }}" required>
                </div>
                <label for="role" class="col-sm-2 col-form-label">Titolo</label>
                <div class="col-mb-3">
                <input type="role" class="form-control" name="role" id="role" placeholder="Titolo" value="{{ $member->role }}">
                </div>
                <label for="description" class="col-sm-2 col-form-label">Descrizione</label>
                <div class="col-mb-3">
                <input type="description" class="form-control" name="description" id="description" placeholder="Descrizione" value="{{ $member->description }}" required>
                </div>
